...
export default class AudioDetector extends EventEmitter {
  ...
  async startRecording() {
    ...
    this.recording.classList.remove("hidden");
    this.recording.classList.add("display");
  }

  async stopRecording() {
    if (this.mediaRecorder.state === "recording") {
      this.mediaRecorder.stop();
      console.log("j'ai arrete de t'ecouter");
      this.recording.classList.remove("display");
      this.recording.classList.add("hidden");
    }
  }
